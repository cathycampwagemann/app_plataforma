...
(function() {
    ...
    input.type = "hidden";
    input.id = "query-params";
    input.name = "query-params";
...
# Inyectar JavaScript en la aplicación de Streamlit
html(get_query_params_js)

# Obtener parámetros de la URL desde el campo oculto
query_params_str = st.text_input("query-params", "", type="hidden")
